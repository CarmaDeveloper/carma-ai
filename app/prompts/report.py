...
RAG_PROMPT_TEMPLATE = (
    ...
    "1. Always respond in English only, regardless of the language used in the survey responses or task description\n"
    "2. Thoroughly analyze the patient survey responses in conjunction with the context information\n"
    "3. Consider the scoring information when evaluating healthcare outcomes and performance\n"
    "4. Identify key patterns, themes, and healthcare insights from the responses\n"
    "5. Pay attention to the hierarchical structure of questions - sub-questions provide important details about parent questions\n"
    "6. Structure your response clearly with appropriate headings and formatting\n"
    "7. Provide specific examples and evidence from the patient data\n"
    "8. Include actionable healthcare recommendations where appropriate\n"
...
NO_CONTEXT_PROMPT_TEMPLATE = (
    ...
    "ANALYSIS INSTRUCTIONS:\n"
    "1. Always respond in English only, regardless of the language used in the survey responses or task description\n"
    "2. Thoroughly analyze the patient survey responses provided\n"
    "3. Consider the scoring information when evaluating healthcare outcomes and performance\n"
    "4. Identify key patterns, themes, and healthcare insights from the responses\n"
    "5. Pay attention to the hierarchical structure of questions - sub-questions provide important details about parent questions\n"
    "6. Structure your response clearly with appropriate headings and formatting\n"
    "7. Provide specific examples and evidence from the patient survey data\n"
    "8. Include actionable healthcare recommendations where appropriate\n"
    "9. Base your analysis solely on the information provided in the patient responses\n"
    "10. Ensure your analysis is objective, data-driven, and clinically relevant\n"
    "11. Extract and highlight any patient concerns, symptoms, or important health details\n\n"
    "Please provide your comprehensive healthcare analysis below:"
)
